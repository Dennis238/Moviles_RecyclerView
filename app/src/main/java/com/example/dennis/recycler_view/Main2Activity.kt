...
class Main2Activity : AppCompatActivity() {
    ...
    fun crearDatosPrueba(): ArrayList<Persona> {
        var personas = ArrayList<Persona>()
        personas.add(Persona("Dennis", "Veintimilla", "1718973779","Estudiante Sistemas","23/08/96","Like"))
        personas.add(Persona("María", "Pérez", "1719375632","Administrativo","11/10/1970","No Like"))
        personas.add(Persona("Fernando", "Alvarado", "1936482489","Profesor","01/12/1980","Like"))
        return personas
    }
